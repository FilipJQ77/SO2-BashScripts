...
find coreutils-8.32 -type f -exec grep -cFx '#include <stdio.h>' '{}' \; | grep -v '0' | wc -l
# u mnie (Windows + WSL) zwróciło 379 zamiast 380, prawdopodobnie ten sam problem
# co w poprzednich laboratoriach (system plików i jeden plik się zagubił)